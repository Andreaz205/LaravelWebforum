...
<template>
    <div>
        <div class="flex items-center mb-4">
            ...
            >
                <Link :href="route('branches.themes.create', branch.id)" class="block w-1/6 mr-4 px-2 py-1 bg-white border border-gray-300 rounded-lg text-center">
                    + Тема
                </Link>
            </template>
        </div>
        <div class="mb-8">
            ...
            >
                <Link
                    class="bg-white p-4 border border-gray-300 w-full flex items-center"
        ...
        <div>
            ...
            <div
                v-for="theme in branch.themes"
                :key="theme.id"
                class="flex items-center"
            >
                <Link
                    class="flex items-center bg-white p-4 border border-gray-300 w-full"
                ...
                >
                    <Link :href="route('themes.edit', theme.id)" class="block bg-sky-600 p-4 rounded-full mx-2">
